...
@NamedQueries({
    ...
    @NamedQuery(name = "Itemcompra.findByPrecoUnitario", query = "SELECT i FROM Itemcompra i WHERE i.precoUnitario = :precoUnitario")})
public class Itemcompra implements Serializable {
    ...
    public Itemcompra(Integer id, Integer quantidade, BigDecimal precoUnitario, Compra idCompra, Produto idProduto) {
        this.id = id;
    ...
    public String toString() {
        return "spassocasaerp.entities.Itemcompra[ id=" + id + " ]";
    }
